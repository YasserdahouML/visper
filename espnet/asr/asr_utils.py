...
# * ------------------ recognition related ------------------ *
def parse_hypothesis(hyp, char_list, lang):
    """Parse hypothesis.
    ...
    idx = 1 if lang is None else 2
    tokenid_as_list = list(map(int, hyp["yseq"][idx:]))
...
def add_results_to_json(nbest_hyps, char_list, lang=None):
    ...
    # parse hypothesis
    rec_text, rec_token, rec_tokenid, score = parse_hypothesis(nbest_hyps[0], char_list, lang)
    return rec_text
